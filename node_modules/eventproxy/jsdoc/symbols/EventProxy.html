				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class EventProxy.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">EventProxy.<b><a href="../symbols/EventProxy.html#.create">create</a></b>()
								</div>
								<div class="description">Create a new EventProxy</div>
							</td>
						</tr>
...
Passing `"all"` will bind the callback to all events fired.
					...
					<pre class="code">proxy.all(ev1, ev2, callback);
proxy.all([ev1, ev2], callback);
proxy.all(ev1, [ev2, ev3], callback);</pre>
					...
					<span class="light">{<a href="../symbols/EventProxy.html">EventProxy</a>}</span>
					<span class="light">EventProxy.</span><b>create</b>()
					...
					<pre class="code">    var ep = EventProxy.create();
    ...
    var ep = EventProxy.create('user', 'articles', function(user, articles) {
      // do something...
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/EventProxy.html">EventProxy</a>}</span> </dd>
...
It equals unbind(); Just add this API for as same as Event.Emitter.
					...
					<b>removeListener</b>(eventName, callback)
...
for all events.
					...
					<b>tail</b>(eventName1, eventName2, callback)
...
then any event that predefined be fired again, the callback will executed with the newest data.
					...
					<pre class="code">proxy.tail(ev1, ev2, callback);
proxy.tail([ev1, ev2], callback);
proxy.tail(ev1, [ev2, ev3], callback);</pre>
...
<!-- ============================== footer ================================= -->
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="http://code.google.com/p/jsdoc-toolkit/" target="_blank">JsDoc Toolkit</a> 2.4.0 on Sat Dec 03 2011 23:38:05 GMT+0800 (CST)
		</div>
	</body>
</html>
