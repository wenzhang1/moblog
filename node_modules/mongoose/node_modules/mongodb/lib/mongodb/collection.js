 ...
 *  - **keepGoing** {Boolean, default:false}, keep inserting documents even if one document has an error, *mongodb 1.10.2 >*.
 *  - **serializeFunctions** {Boolean, default:false}, serialize functions on the document.
 *
...
var insertAll = function insertAll (self, docs, options, callback) {
  ...
  var insertFlags = {};
  // If we have a mongodb version >= 1.10.2 support keepGoing attribute
